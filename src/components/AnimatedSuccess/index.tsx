...
export const SuccessAnimated = props => {
   return (
      <SvgIcon {...props} id='successAnimation' className='animated' width='70' height='70' viewBox='0 0 70 70'>
...
export default React.memo(SuccessAnimated)
