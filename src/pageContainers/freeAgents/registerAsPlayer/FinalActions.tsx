...
const ResetStepperBtn: React.FC<ResetStepperBtnProps> = props => {
   ...
   return (
      <>
         ...
         {!playerID && <Button disabled={formik.isSubmitting} onClick={handleClick()} startIcon={<ClearRoundedIcon />} variant='outlined' style={{ marginLeft: '1em', ...onBack && !playerID && resetStyle }} >
