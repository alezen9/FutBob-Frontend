...
import { User } from '@_swr/Me/node_modules/@_SDK_User/entities'
import { EditableUser } from '@_SDK_User/types'
import { setSnackbarData } from '@_zustand/helpers'
import { Player as PlayerEntity } from '@_swr/Me/node_modules/@_SDK_Player/entities'
...
const ProfileContainer = () => {
	...
	return (
		<ZenTabs>
			<ZenTab title='General' component={<General {...tabProps} />} />
			<ZenTab title='Private' component={<Private {...tabProps} />} />
			<ZenTab title='Player' component={<Player {...tabProps} />} />
		</ZenTabs>
	)
}
