...
import { Player } from '@_swr/Me/node_modules/@_SDK_Player/entities'
...
const PlayersContainer = () => {
	...
	const onFiltersSubmit = useCallback(values => {
	...
	return (
		<>
			...
			/>
			<ZenTable withMask isFetching={isValidating} withActions headers={headers} data={tableData} pagination={<ZenPagination totalCount={totalCount} currentPage={currentPage} onChangePage={handleChangePage} />} />
			<WarningDeleteDialog
				open={!!currentItem}
				text={
					<>
